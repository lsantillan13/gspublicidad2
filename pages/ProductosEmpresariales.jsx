...
const RegalosEmpresariales = () => {
  ...
  // Datos para el banner hero específico de regalos empresariales
  const bannerSlides = [
    {
      id: 1,
      title: "Regalos Empresariales",
      subtitle: "Soluciones personalizadas para fortalecer tus relaciones comerciales",
    ...
    },
    {
      ...
      subtitle: "Tu logo en productos de la más alta calidad",
    ...
    },
    {
      ...
      subtitle: "Productos exclusivos que tus clientes recordarán",
  ...
  return (
    <section className='container-xl'>
      <Geder />
      <section className="min-h-screen bg-gradient-to-br from-blue-50 py-16 md:py-32 relative via-white to-indigo-50">
        
        {/* Banner Hero para Regalos Empresariales */}
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
          ...
          <div className="text-center mb-12 sm:mb-16 lg:mb-20">
            <div className="inline-flex items-center gap-2 sm:gap-3 bg-white/80 backdrop-blur-md rounded-full px-4 py-2 sm:px-6 sm:py-3 border border-blue-200 mb-4 shadow-sm">
            ...
            <p className="text-lg sm:text-xl lg:text-2xl text-slate-600 max-w-3xl mx-auto font-light">
              Descubre nuestra exclusiva colección de productos para empresas y corporativos
            </p>

            {/* Filtros por Categoría */}
            <div className="flex justify-center mt-8">
              <div className="bg-white/80 backdrop-blur-sm rounded-full p-1 border border-blue-200 shadow-sm flex flex-wrap justify-center gap-1">
                <button
                    ...
                    >
                      ...
                      <div className="relative w-full aspect-square overflow-hidden bg-gradient-to-br from-slate-100 to-slate-200">
                        ...
                        <div className="absolute top-3 left-3 flex flex-col gap-2">
                          {product.category && (
                            <span className="bg-blue-500/90 text-white text-xs font-bold px-2 py-1 rounded-full backdrop-blur-sm">
                              {product.category}
                            </span>
                          )}
                      ...
                      <div className="p-4 sm:p-6 space-y-3">
                        ...
                        <Link
                          ...
                          className="block w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white text-center font-semibold py-2.5 px-4 rounded-lg transition-all duration-300 hover:shadow-lg border border-blue-600"
                        >
                          Ver Detalles
                        </Link>
                      </div>
          ...
          {!loading && filteredProducts.length === 0 && (
            <div className="text-center py-12">
              ...
              <h3 className="text-2xl font-bold text-slate-700 mb-2">
                {filter === 'all' ? 'No hay productos disponibles' : `No hay productos en ${filter}`}
              </h3>
              <p className="text-slate-600 mb-6">
                {filter === 'all' 
                  ? 'Estamos actualizando nuestro catálogo empresarial' 
