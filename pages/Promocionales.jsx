...
const Promocionales = () => {
  ...
  // Datos para el banner hero específico de artículos empresariales
  const bannerSlides = [
    {
      id: 1,
      title: "Artículos Empresariales",
      subtitle: "Productos promocionales de alta calidad para tu marca",
    ...
    },
    {
      ...
      subtitle: "Fortalece tu identidad con productos personalizados",
    ...
    {
      id: 3,
      title: "Soluciones Promocionales",
      subtitle: "Ideales para eventos, clientes y equipos de trabajo",
      image: "https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=1200&h=600&fit=crop",
      cta: "Ver Soluciones",
      link: "/promocionales",
      bgGradient: "from-turquoise-500/20 to-cyan-600/20"
    }
  ];
  ...
  return (
    <section className='container-xl'>
      <Geder />
      <section className="min-h-screen bg-gradient-to-br from-cyan-50 py-16 md:py-32 relative via-white to-sky-50">
        
        {/* Banner Hero para Artículos Empresariales */}
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
          ...
          <div className="text-center mb-12 sm:mb-16 lg:mb-20">
            ...
            <p className="text-lg sm:text-xl lg:text-2xl text-slate-600 max-w-3xl mx-auto font-light">
              Productos promocionales ideales para marketing, eventos corporativos y fidelización de clientes
            </p>
                    ...
                    >
                      ...
                      <div className="relative w-full aspect-square overflow-hidden bg-gradient-to-br from-slate-100 to-slate-200">
                        ...
                        <div className="absolute top-3 left-3 flex flex-col gap-2">
                          ...
                          {hasDiscount && discountPercent && (
                            <span className="bg-rose-500/90 text-white text-xs font-bold px-2 py-1 rounded-full backdrop-blur-sm">
                              -{discountPercent}%
                            </span>
                          )}
                      ...
                      <div className="p-4 sm:p-6 space-y-3">
                        ...
                        <p className="text-slate-600 text-sm leading-relaxed line-clamp-2">
                          {product.description || 'Artículo promocional de alta calidad'}
                        </p>
                        ...
                        <Link
                          ...
                          className="block w-full bg-gradient-to-r from-cyan-600 to-sky-600 hover:from-cyan-500 hover:to-sky-500 text-white text-center font-semibold py-2.5 px-4 rounded-lg transition-all duration-300 hover:shadow-lg border border-cyan-600"
                        >
                          Ver Detalles
                        </Link>
                      </div>
          ...
          {!loading && filteredProducts.length === 0 && (
            <div className="text-center py-12">
              ...
              <p className="text-slate-600 mb-6">
                {filter === 'all' 
                  ? 'Estamos actualizando nuestro catálogo de artículos empresariales' 
                  : 'Pronto tendremos productos promocionales en esta categoría'
                }
              </p>
              {filter !== 'all' && (
                <button
