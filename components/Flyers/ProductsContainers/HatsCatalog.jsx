...
const ProductCardSkeleton = () => (
  <div className="group flex flex-col bg-white/90 backdrop-blur-lg rounded-2xl sm:rounded-3xl overflow-hidden border border-slate-200 animate-pulse h-[400px]">
...
const HatsCatalog = () => {
  ...
  const categories = [
    { id: 'todos', name: 'Todo', icon: '', color: 'from-cyan-500 to-blue-500' },
    { id: 'gorros', name: 'Gorros', icon: '🧢', color: 'from-cyan-500 to-blue-500' },
    { id: 'pilusos', name: 'Pilusos', icon: '🧵', color: 'from-emerald-500 to-green-500' },
    { id: 'sombreros', name: 'Sombreros', icon: '🎩', color: 'from-amber-500 to-orange-500' },
  ];
        ...
        setProducts([
          {
            ...
            price: '$299',
            image: 'https://images.unsplash.com/photo-1576871337632-b9aef4c17ab9?w=400&auto=format&fit=crop',
            category: 'gorros'
          },
          {
            _id: '2',
            ...
            price: '$249',
            image: 'https://images.unsplash.com/photo-1521369909029-2afed882baee?w=400&auto=format&fit=crop',
            category: 'pilusos'
          },
          {
            _id: '3',
          ...
          },
          {
            ...
            description: 'Tecnología de secado rápido',
            price: '$279',
            image: 'https://images.unsplash.com/photo-1521310194286-4c00b3233178?w=400&auto=format&fit=crop',
            category: 'gorros'
          },
          {
            _id: '5',
            name: 'Piluso Personalizable',
            description: 'Perfecto para branding corporativo',
            price: '$269',
            image: 'https://images.unsplash.com/photo-1588850561407-ed78c282e89b?w=400&auto=format&fit=crop',
            category: 'pilusos'
          },
          {
            _id: '6',
            name: 'Sombrero Panama',
            description: 'Protección solar premium',
            price: '$459',
            image: 'https://images.unsplash.com/photo-1561948955-570b270e7c36?w=400&auto=format&fit=crop',
            category: 'sombreros'
          }
        ]);
      } finally {
                ...
                >
                  ...
                  >
                    <div className={`
                      ...
                      border border-slate-200 transition-all duration-300 h-full
                    ...
                    `}>
                      ...
                      <div className="absolute top-3 right-3">
                        <span className={`
                          ...
                          ${product.category === 'gorros' ? 'bg-cyan-100 text-cyan-700' :
                            product.category === 'pilusos' ? 'bg-emerald-100 text-emerald-700' :
